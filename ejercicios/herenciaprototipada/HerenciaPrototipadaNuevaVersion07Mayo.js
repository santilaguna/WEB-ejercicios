...
// En particular no queremos reescribir los m�todos.

// se usa el prototipo 
 agricultor.__proto__ = trabajador;  //__proto__ NO lo hagan, esto est� algo obsoleto
...
//Con que propiedades qued� agricultor2? Las recorremos prop
...
// Est� este objeto heredando de trabajador?

console.log(trabajador.isPrototypeOf(agricultor))
console.log(agricultor.isPrototypeOf(trabajador))

//****objetivo: que el objeto alfarero herede de trabajador******.

let alfarero = { 
   nombre:"alfareros supremos",
   alianza: 1,
   tipo:"agricultor",
   habilidad: 12,
   operarTorno(){
     console.log("operando el torno con habilidad ", this.habilidad);
   }
}

//Por qu� se va a caer esto??!!
alfarero.operarTorno()

//Propiedades alfarero:
console.log("\nPropiedades alfarero:")
for( let propiedad in alfarero ){
  console.log(propiedad)
}
console.log("--------")

//Realizamos la herencia del alfarero:
Reflect.setPrototypeOf(alfarero, trabajador)
console.log("\nPropiedades alfarero:")
for( let propiedad in alfarero ){
  console.log(propiedad)
}
...
// Tenemos el objeto industria ahora.
let industria = {
  tipo:"metal�rgica",
...
// el metodo mejora, incrementa la experiencia.
industria.mejora();

console.log(" Experiencia Industria despues: ", industria.experiencia);

// Como reuso experiencia para el agricultor sin tener que hacer una herencia prototipada?
...
//Podr�a heredar de TrabajadorProfesional, por ejemplo

let doctor = {
  nombre:"los hipocr�ticos",
  alianza: 1,
  salud:700,
  tipo:"doctor",
  experiencia:203,

  //Ac� la funci�n atender nos va a ayudar
  //Esta funcion recibe tres par�metros.
...
//OJO Bind retorna una funci�n y nosotros la invocamos cuando lo estimemos
/*
