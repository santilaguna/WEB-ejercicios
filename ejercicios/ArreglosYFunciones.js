...
function hazmeImpar(paramArreglo) {
  ...
  paramArreglo.forEach((valor) => {arregloImpar.push(1) } );
...
/*
const nuevoArregloImpar = arregloDos.map(  => formula ); //Ac� se provee la funcion a aplicar a los elementos del arreglo.
