...
let trabajador = { 
  ...
  saludo() { console.log("Saludos! somos ", this.nombre)}, //Se va a caer.
...
// se usa el prototipo 
 agricultor.__proto__ = trabajador;  //__proto__ NO hagan esto en CASA!
console.log("tipo:", agricultor.salud);
agricultor.saludo();



//Reflect.setPrototypeOf(target, prototype)
let agricultor2 = Object.create(agricultor); //Esta es la forma ya conocida y la buena
...
for( let propiedad in agricultor2 ){
  console.log(agricultor.hasOwnProperty(propiedad), propiedad)
  if (agricultor2.hasOwnProperty(propiedad)) {
  console.log(propiedad)}
}
